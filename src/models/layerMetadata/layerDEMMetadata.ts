...
import { DEMDataType, NoDataValue, RecordType, UndulationModel } from '../pycsw/coreEnums';
...
export interface ILayerMetadata {
  ...
  dataType: DEMDataType | undefined;
...
export class LayerDemMetadata implements ILayerMetadata, IMetadataCommonModel {
  ...
  @fieldConfig({
    category: FieldCategory.MAIN,
    isAutoGenerated: true,
    infoMsgCode: ['info-field-tooltip.resolutionDegree.tooltip'],
  })
  //#endregion
  ...
  @fieldConfig({
    category: FieldCategory.MAIN,
    isAutoGenerated: true,
    infoMsgCode: ['info-field-tooltip.resolutionMeter.tooltip'],
  })
  //#endregion
  public resolutionMeter: number | undefined = undefined;

  //#region DEM: imagingSortieAccuracyCEP90
  @pycsw({
    profile: 'mc_dem',
    xmlElement: 'mc:imagingSortieAccuracyCEP90',
    queryableField: 'mc:imagingSortieAccuracyCEP90',
    pycswField: 'pycsw:imagingSortieAccuracyCEP90',
  })
  @catalogDB({
    column: {
      name: 'imaging_sortie_accuracy_cep_90',
      type: 'real',
      nullable: true,
    },
  })
  ...
  @fieldConfig({
    category: FieldCategory.MAIN,
    isFilterable: true,
    infoMsgCode: ['info-field-tooltip.imagingSortieAccuracyCEP90.tooltip'],
  })
  //#endregion
  public imagingSortieAccuracyCEP90: number | undefined = undefined;
  ...
  //#endregion
  public dataType: DEMDataType | undefined = undefined;
  ...
  //#region DEM: hasTerrain
  @pycsw({
    profile: 'mc_dem',
    xmlElement: 'mc:hasTerrain',
    queryableField: 'mc:hasTerrain',
    pycswField: 'pycsw:hasTerrain',
  })
  @catalogDB({
    column: {
      name: 'has_terrain',
  ...
  @tsTypes({
    mappingType: TsTypes.BOOLEAN,
  })
  @graphql({
    nullable: true,
  })
  //#endregion
  public hasTerrain: boolean | undefined = false;
  //#endregion
