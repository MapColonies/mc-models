...
export class LayerDemMetadata implements ILayerMetadata, IMetadataCommonModel {
  ...
  @fieldConfig({
    category: FieldCategory.MAIN,
    infoMsgCode: [
      'info-field-tooltip.resolutionDegree.tooltip',
      'info-field-tooltip.resolutionDegree.min',
      'info-field-tooltip.resolutionDegree.max',
    ],
    validation: [
      {
  ...
  @fieldConfig({
    category: FieldCategory.MAIN,
    infoMsgCode: [
      'info-field-tooltip.resolutionMeter.tooltip',
      'info-general-tooltip.required',
      'info-field-tooltip.resolutionMeter.min',
      'info-field-tooltip.resolutionMeter.max',
    ],
    validation: [
      {
        errorMsgCode: 'validation-general.required',
